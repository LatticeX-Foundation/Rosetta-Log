...
void basic_example()
{
    ...
    my_logger->set_pattern("[%H:%M:%S %z] [%^%L%$] [thread %t] %v");
    my_logger->info("basic_example!!!");
    my_logger->error("basic_example!!!");
}
...
void multi_sink_example()
{
    ...
    logger.error("this should appear in both console and file");
    logger.warn("this should appear in both console and file");
    logger.info("this message should not appear in the console, only in the file");
    logger.audit("############this message should not appear in the console, only in the file");
    logger.debug("############this message should not appear in the console, only in the file");
    logger.trace("############this message should not appear in the console, only in the file");
}
